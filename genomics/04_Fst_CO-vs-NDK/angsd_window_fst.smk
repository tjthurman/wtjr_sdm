...
rule all:
    input:
        ...
        expand(bd_out("by_scaff_idx/{scaffold}.fst.idx"), scaffold = scaffolds)
...
rule sfs_2d:
    ...
    shell:
        """
        /home/tt164677e/angsd-compiledfromgithub/bin/realSFS -P {resources.cpus} {input.pop1_saf} {input.pop2_saf} -ref /mnt/beegfs/tt164677e/genomes/lepus_townsendii/DMNS18807_06042020_pseudohap2.1_10k.fasta > {output} 2> {log}
        """
